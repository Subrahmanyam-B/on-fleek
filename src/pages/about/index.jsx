      ...
      <div className="mt-20 text-white md:px-20 px-5 pb-20 space-y-5">
        ...
        <div className="flex">
          <div className="w-full flex flex-col items-center gap-5">
            <div className="bg-white/30 rounded-full w-28 h-28 relative">
              <Image
            ...
            <div className="space-y-0.5 text-center text-sm">
              <div className="text-base">Stalin</div>
              <div>Founder</div>
            </div>
          </div>
        </div>
        <div className="xl:px-52 md:px-32 sm:px-10 px-5 pb-10 text-center">
